...
namespace IntegrationTests.Download
{
    ...
    class TestsWithHttpServer : BaseTestWithHttpServer
    {
        ...
        public async Task DownloadAndVerificationWorks()
        {
            ...
            var fileUrl = new UriString($"http://localhost:{server.Port}/unity/git/windows/git-lfs.zip");
            var md5Url = new UriString($"http://localhost:{server.Port}/unity/git/windows/git-lfs.zip.md5");
        ...
        public async Task FailsIfVerificationFails()
        {
            ...
            var fileUrl = new UriString($"http://localhost:{server.Port}/unity/git/windows/git.zip");
            var md5Url = new UriString($"http://localhost:{server.Port}/unity/git/windows/git-lfs.zip.md5");
        ...
        public async Task DownloadsRunSideBySide()
        {
            ...
            var fileUrl1 = new UriString($"http://localhost:{server.Port}/unity/git/windows/git-lfs.zip");
            var md5Url1 = new UriString($"http://localhost:{server.Port}/unity/git/windows/git-lfs.zip.md5");
            var fileUrl2 = new UriString($"http://localhost:{server.Port}/unity/git/windows/git.zip");
            var md5Url2 = new UriString($"http://localhost:{server.Port}/unity/git/windows/git.zip.md5");
